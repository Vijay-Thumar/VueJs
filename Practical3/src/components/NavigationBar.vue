<template>
  <div class="Navigation_bar">
    <div>Car gallery</div>
    <div>
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#AddCarForm">
        Add Car
      </button>
      <div class="modal fade" id="AddCarForm" tabindex="-1" role="dialog" aria-labelledby="AddCarFormLabel"
        aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <Form @submit="onSubmit" :validation-schema="schema">
                <div>
                  <Field id="heading" name="heading" type="text" placeholder="Heading:- Ex:- Ambassador"
                    class="form-control" />
                ...
                <div>
                  <Field id="details" name="details" type="text"
                    placeholder="Description Ex:- Owner of this Organization" class="form-control" />
                  <ErrorMessage name="details" class="text-danger h6" />
                </div>

                <div>
                  <Field id="specs" name="specs" type="text"
                    placeholder="Specification Ex:- Power-HP/500CC Petrol/Diesel" class="form-control" />
